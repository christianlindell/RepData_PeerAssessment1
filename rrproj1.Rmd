...
A total of `r missingIntervals` five minutes intervals are completly missing in the dataset and their values are not marked as NA. Because they are missing in the data evenly for all days, no messures has been made to impute values to these missing intervals.
